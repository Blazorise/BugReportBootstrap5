# Blazorise Bug Report Template for Bootstrap5
...
(Not using `Bootstrap5` or need more flexibility? Check out additional templates [here](https://github.com/Blazorise/BugReportTemplate).)